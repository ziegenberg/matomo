...
class PromoMediaAnalytics extends DismissibleWidget
{
    ...
    public function render()
    {
        ...
        $view->listOfFeatures = [
            Matomo::translate('ProfessionalServices_MediaAnalyticsFeature01'),
            Matomo::translate('ProfessionalServices_MediaAnalyticsFeature02'),
            Matomo::translate('ProfessionalServices_MediaAnalyticsFeature03'),
        ];
