 ...
 * {@see \Matomo\Plugins\BotTracking\RecordBuilders\AIChatbotFavouredPages} (the AI chatbot
...
class AIChatbotRequests extends AggregatedMetric
{
    ...
    {
        return Matomo::translate('BotTracking_ColumnAIChatbotRequests');
    }

    public function getDocumentation()
    {
        return Matomo::translate('BotTracking_ColumnAIChatbotRequestsDocumentation');
    }
