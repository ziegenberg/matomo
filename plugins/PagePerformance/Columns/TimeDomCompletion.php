...
class TimeDomCompletion extends Base
{
    ...
    public function configureMetrics(MetricsList $metricsList, DimensionMetricFactory $dimensionMetricFactory)
    {
        ...
        $metric3->setTranslatedName(Matomo::translate('PagePerformance_ColumnViewsWithTimeDomCompletion'));
        ...
        $metric->setTranslatedName(Matomo::translate('PagePerformance_ColumnAverageTimeDomCompletion'));
        $metric->setDocumentation(Matomo::translate('PagePerformance_ColumnAverageTimeDomCompletionDocumentation'));
