...
class TimeServer extends Base
{
    ...
    public function configureMetrics(MetricsList $metricsList, DimensionMetricFactory $dimensionMetricFactory)
    {
        ...
        $metric3->setTranslatedName(Matomo::translate('PagePerformance_ColumnViewsWithTimeServer'));
        ...
        $metric->setTranslatedName(Matomo::translate('PagePerformance_ColumnAverageTimeServer'));
        $metric->setDocumentation(Matomo::translate('PagePerformance_ColumnAverageTimeServerDocumentation'));
