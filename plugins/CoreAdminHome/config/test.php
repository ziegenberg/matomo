...
return array(
    ...
    'Matomo\Tracker\Failures' => Matomo\DI::decorate(function ($previous) {
        /** @var Failures $previous */

        $generate = \Matomo\Container\StaticContainer::get('test.vars.generateTrackingFailures');
        if ($generate) {
            $previous->setNow(\Matomo\Date::factory('2018-07-07 01:02:03'));
