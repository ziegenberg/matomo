...
use Matomo\Tests\PHPStan\Rules\NoRawJsonHeaderInControllerRule;
    ...
    public function testRule(): void
    {
        $this->analyse([__DIR__ . '/data/JsonResponseController.php'], [
            [
                ...
                . ' Common::sendHeader(). Mark the action with the #[\Matomo\Http\JsonResponse] attribute'
            ...
            [
                'Controller action attributedRawHeader() is marked #[\Matomo\Http\JsonResponse], which'
