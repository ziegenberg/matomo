...
class DataComparisonTest extends SystemTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $idDimension = \Matomo\Plugins\CustomDimensions\API::getInstance()->configureNewCustomDimension(
            self::$fixture->idSite,
            'test',
        ...
        \Matomo\Plugins\SegmentEditor\API::getInstance()->add('custom dimension', "dimension$idDimension==test", self::$fixture->idSite);
    }
